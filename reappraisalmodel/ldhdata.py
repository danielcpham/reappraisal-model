...
class LDHData:
    ...
    def train_dataset(self):
        """
        Easy access for training dataset.
        """
    ...
    def load_training_data(
        ...
        Loads from cache if it already been read, otherwise (or if force_reload is `True`)
        reads the data spreadsheets again.
        """
...
class LDHDataModule(lit.LightningDataModule):
    """
    DataModule definition for LDH data.
    """
    #TODO: Split into LDHI, II, and III
